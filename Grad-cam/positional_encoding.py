"""Code from : https://github.com/JHLew/Learnable-Fourier-Features"""
import torch
...
#     """
#     lff = LearnableFourierFeatures(pos_dim=2, f_dim=128, h_dim=256, d_dim=64, g_dim=1).to(device)
#     pos = torch.randn([4, 1024, 1, 2]).to(device)
#     pe = lff(pos)
#     print(pe)
#     print(pe.shape)
...
#     positional dimension: 2
#     """
#     ff = FourierFeatures(pos_dim=2, f_dim=256).to(device)
#     pos = torch.randn([4, 32, 32, 2]).to(device)
#     pe = ff(pos)
#     print(pe)
#     print(pe.shape)
...
#     positional dimension: 2
#     """
#     PE = PositionalEncoding(pos_dim=2, enc_dim=256).to(device)
#     pos = torch.randn([4, 1024, 2]).to(device)
#     pe = PE(pos)
#     print(pe)
#     print(pe.shape)
